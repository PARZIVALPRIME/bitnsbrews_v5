        ...
        {visMode !== "thermal" && (
          <mesh position={[0, h + 0.025, 0]}>
            ...
            {isMobile ? (
              ...
              // Desktop-only — meshPhysicalMaterial (iridescence + clearcoat) is GPU-heavier,
              // so phones keep the cheaper meshStandardMaterial above.
              <meshPhysicalMaterial
                // capMat is typed MeshStandardMaterial; MeshPhysicalMaterial extends it,
                // so the useFrame emissive/opacity animation still works at runtime.
                ref={capMat as any}
                color={block.base}
                metalness={visMode === "logical" ? 0.95 : Math.min(0.95, block.metalness * 1.45)}
                roughness={visMode === "logical" ? 0.15 : Math.max(0.12, block.roughness * 0.45)}
